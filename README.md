...
2. No painel de navegação da esquerda, selecione **Painel do EC2** para garantir que você esteja na página do painel
...
- Configurar o servidor web para ser iniciado automaticamente na inicialização
- Ativar o servidor web
- Criar uma página da web simples
...
### Acessando as Métricas do CloudWatch
...
### Obtendo a Captura de Tela da Instância
...
### Acessando o Servidor Web Novamente
...
Quando a instância for iniciada novamente, ela será do tipo **t3.small**, que tem o dobro de memória de uma instância t3.micro.
...
- Altere o tamanho para: **10 GiB**

> **OBSERVAÇÃO:** a criação de grandes volumes do Amazon EBS pode estar restrita neste laboratório.
...
> **Observação Importante:** você notará que a instância **não foi terminada** e uma mensagem de erro vermelha é exibida na parte superior que diz: "Falha ao terminar uma instância: talvez a instância não tenha sido terminada". O motivo é porque ela tem a **proteção contra encerramento ativada**.

### Desativando a Proteção Contra Encerramento
